...
public class ManagementEndpointAuthenticationFilter extends GenericFilterBean {
    ...
    private void prepareManagementEndpointsSet() {
        ...
        managementEndpoints.add(Constants.AUTOCONFIG_ENDPOINT);
        managementEndpoints.add(Constants.BEANS_ENDPOINT);
        managementEndpoints.add(Constants.CONFIGPROPS_ENDPOINT);
        managementEndpoints.add(Constants.ENV_ENDPOINT);
        managementEndpoints.add(Constants.MAPPINGS_ENDPOINT);
        managementEndpoints.add(Constants.METRICS_ENDPOINT);
        managementEndpoints.add(Constants.SHUTDOWN_ENDPOINT);
    }
