...
public class PropertyLendListProcessor extends BaseProcessor{
	...
	protected String executeProcess(Map scopes) {
		...
		if(moreComment){
			tableBeanList =  (ArrayList<PropertyLendJoinTable>)propertyMgr.getLendingPropertyListLimitedNumberStartFromId(request.getStartId(), numbers);
		}else{
			tableBeanList = (ArrayList<PropertyLendJoinTable>)propertyMgr.getLendingPropertyListLimitedNumber(numbers);
		}
		try{
