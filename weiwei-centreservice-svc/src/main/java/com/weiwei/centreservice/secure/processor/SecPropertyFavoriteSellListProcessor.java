...
public class SecPropertyFavoriteSellListProcessor extends BaseProcessor{
	...
	protected String executeProcess(Map scopes) {
		...
		if(moreComment){
			tableBeanList =  (ArrayList<PropertySellJoinTable>)propertyMgr.getFavoriteSellListLimitedNumberStartFromId(username, request.getStartId(), numbers);
		}else{
			tableBeanList = (ArrayList<PropertySellJoinTable>)propertyMgr.getFavoriteSellListLimitedNumber(username, numbers);
		}
		try{
