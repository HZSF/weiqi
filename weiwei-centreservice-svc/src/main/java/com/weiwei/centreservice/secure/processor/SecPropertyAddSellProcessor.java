...
public class SecPropertyAddSellProcessor extends BaseProcessor {
	protected ApplicationContext ctx;
	private String username;
	private PropertyAddSellRequest request;
	@Override
	protected void preProcess(Map scopes){
		username = (String)scopes.get(Constants.USERNAME);
		request = (PropertyAddSellRequest)scopes.get(Constants.PROPERTY_REQUEST);
	}
	...
	protected String executeProcess(Map scopes) {
		...
		try{
			...
			propertyMgr.insertSellProperty(username, region, category, property_area, levels, ask_price, description);
